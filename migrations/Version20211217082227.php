 ...
 */
final class Version20211217082227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mtmue ADD CONSTRAINT FK_6C42333D71F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
        $this->addSql('ALTER TABLE mtmue ADD CONSTRAINT FK_6C42333DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
